...
// POST WRITE
export const POST_WRTIE_REQUEST = "POST_WRTIE_REQUEST";
export const POST_WRTIE_SUCCESS = "POST_WRTIE_SUCCESS";
export const POST_WRTIE_FAILURE = "POST_WRTIE_FAILURE";
